    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <form action="{{ route('buku.do-search') }}" method="POST" class="bg-white dark:bg-slate-800 p-4 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 mb-8 flex flex-col md:flex-row gap-4 items-center">
            ...
            <div class="relative w-full md:w-auto custom-dropdown" data-auto-submit="true">
                ...
                <button type="button" class="dropdown-btn flex items-center justify-between gap-3 bg-white dark:bg-slate-800 rounded-2xl py-4 px-6 focus:ring-2 focus:ring-indigo-500 transition-all text-slate-700 dark:text-slate-300 cursor-pointer min-w-[180px] hover:bg-slate-50 dark:hover:bg-slate-700">
