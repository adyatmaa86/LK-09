        ...
        <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 overflow-hidden border border-slate-100">
            <div class="p-8 sm:p-12">
                <div class="mb-10">
                    ...
                    <p class="text-slate-500">Perbarui informasi buku <span class="font-bold text-indigo-600">"{{ $buku->title }}"</span>.</p>
                </div>
                ...
                <form action="{{ route('buku.update', $buku) }}" method="POST" enctype="multipart/form-data" class="space-y-8" novalidate>
                            ...
                            <div class="relative custom-dropdown">
                                ...
                                <div class="dropdown-menu absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden z-50 hidden opacity-0 translate-y-2 transition-all duration-300">
                                    <div class="p-2 space-y-0.5">
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 transition-colors {{ old('category', $buku->category) == 'Fiksi' ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600' }}" data-value="Fiksi">
                                        ...
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 transition-colors {{ old('category', $buku->category) == 'Non-Fiksi' ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600' }}" data-value="Non-Fiksi">
                                        ...
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 transition-colors {{ old('category', $buku->category) == 'Teknologi' ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600' }}" data-value="Teknologi">
                                        ...
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 transition-colors {{ old('category', $buku->category) == 'Sains' ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600' }}" data-value="Sains">
                                        ...
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 transition-colors {{ old('category', $buku->category) == 'Sejarah' ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600' }}" data-value="Sejarah">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-100 border-dashed rounded-3xl bg-slate-50/50 hover:bg-slate-50 transition-colors group">
