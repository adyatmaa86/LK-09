            ...
            <div class="p-8 sm:p-12">
                ...
                <form action="{{ route('buku.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8" novalidate>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="author" id="author" value="{{ old('author') }}" required
                                class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-900/50 dark:text-white border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 transition-all placeholder:text-slate-400 @error('author') ring-2 ring-rose-500 @enderror"
                            ...
                            <div class="relative custom-dropdown">
                                ...
                                <div class="dropdown-menu absolute top-full left-0 right-0 mt-2 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 overflow-hidden z-50 hidden opacity-0 translate-y-2 transition-all duration-300">
                                    ...
                                    <div class="p-2 space-y-0.5">
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors {{ old('category') == 'Fiksi' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300' : 'text-slate-600 dark:text-slate-400' }}" data-value="Fiksi">
                                        ...
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors {{ old('category') == 'Non-Fiksi' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300' : 'text-slate-600 dark:text-slate-400' }}" data-value="Non-Fiksi">
                                        ...
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors {{ old('category') == 'Teknologi' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300' : 'text-slate-600 dark:text-slate-400' }}" data-value="Teknologi">
                                        ...
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors {{ old('category') == 'Sains' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300' : 'text-slate-600 dark:text-slate-400' }}" data-value="Sains">
                                        ...
                                        <div class="dropdown-item flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors {{ old('category') == 'Sejarah' ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300' : 'text-slate-600 dark:text-slate-400' }}" data-value="Sejarah">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 @error('cover') border-rose-500 bg-rose-50/50 @else border-slate-100 dark:border-slate-700 @enderror border-dashed rounded-3xl bg-slate-50/50 dark:bg-slate-900/50 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors group">
