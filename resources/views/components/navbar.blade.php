        ...
        <div class="flex justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <div class="flex items-center gap-3 pl-2">
                    <button id="theme-toggle" type="button" class="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center border border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all duration-300">
                        <!-- Dark icon -->
                        <svg id="theme-toggle-dark-icon" class="hidden h-5 w-5 text-slate-500 dark:text-slate-400" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                        </svg>
                        <!-- Light icon -->
                        <svg id="theme-toggle-light-icon" class="hidden h-5 w-5 text-amber-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="md:hidden flex items-center">
                <button type="button" class="p-2 rounded-xl bg-slate-50 text-slate-600 hover:bg-slate-100 transition-colors">
