        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12 text-center md:text-left">
            ...
            <div class="flex flex-col items-center md:items-start">
                ...
                <div class="flex gap-4">
                    <a href="https://wa.me/6285259445820" target="_blank" class="w-10 h-10 rounded-full bg-[#25D366]/10 flex items-center justify-center text-[#25D366] hover:bg-[#25D366] hover:text-white transition-all duration-500 shadow-sm" title="Hubungi via WhatsApp">
                    ...
                    <a href="https://www.instagram.com/adyatmagomo/" target="_blank" class="relative w-10 h-10 rounded-full flex items-center justify-center transition-all shadow-sm overflow-hidden group" title="Kunjungi Instagram">
                        <div class="absolute inset-0 bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] opacity-10 group-hover:opacity-100 transition-opacity duration-500"></div>
