<footer class="bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 py-12 mt-20 transition-colors duration-300">

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div class="col-span-1 md:col-span-2">
                <a href="{{ route('buku.index') }}" class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h4 class="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-widest mb-6 cursor-default">Navigasi</h4>
            ...
            <div>
                <h4 class="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-widest mb-6 cursor-default">Kontak</h4>
                ...
                <div class="flex gap-4">
                    <a href="https://wa.me/6285259445820" target="_blank" class="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-emerald-50 hover:text-emerald-600 transition-all" title="Hubungi via WhatsApp">
                    ...
                    <a href="https://www.instagram.com/adyatmagomo/" target="_blank" class="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-indigo-50 hover:text-indigo-600 transition-all">
        ...
        <div class="pt-8 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-slate-400 text-xs cursor-default">
                &copy; {{ date('Y') }} AdyatmaBooks. Dikelola oleh <span class="font-bold text-slate-600">Ceo Adyatma86</span>. Semua hak dilindungi.
            </p>
            <div class="flex gap-6">
                <a href="javascript:void(0)" id="syarat-ketentuan" class="text-slate-400 hover:text-slate-600 text-xs transition-colors">Syarat & Ketentuan</a>
                <a href="javascript:void(0)" id="kebijakan-privasi" class="text-slate-400 hover:text-slate-600 text-xs transition-colors">Kebijakan Privasi</a>
